...
public class OrderedThreadPoolExecutor extends ThreadPoolExecutor {
    ...
    private static final com.hjcenry.threadPool.order.OrderedThreadSession EXIT_SIGNAL = new com.hjcenry.threadPool.order.OrderedThreadSession();

    /**
     * A queue used to store the available sessions
     */
    private final Queue<com.hjcenry.threadPool.order.OrderedThreadSession> waitingSessions = new ConcurrentLinkedQueue<>();
    ...
    public List<Runnable> shutdownNow() {
        ...
        com.hjcenry.threadPool.order.OrderedThreadSession session;
    ...
    private boolean offerWaitSession(com.hjcenry.threadPool.order.OrderedThreadSession session) {
    ...
    public boolean remove(Runnable task) {
        IOrderTask event = (IOrderTask) task;
        com.hjcenry.threadPool.order.OrderedThreadSession session = event.getSession();
        Queue<Runnable> tasksQueue = session.getQueue();
    ...
    private class Worker implements Runnable, WaitCondition<com.hjcenry.threadPool.order.OrderedThreadSession> {
        ...
        public void run() {
            ...
            try {
                for (; ; ) {
                    com.hjcenry.threadPool.order.OrderedThreadSession session = null;
                    try {
        ...
        private com.hjcenry.threadPool.order.OrderedThreadSession fetchSession() {
            com.hjcenry.threadPool.order.OrderedThreadSession session = null;
        ...
        private void runTasks(com.hjcenry.threadPool.order.OrderedThreadSession session) {
        ...
        @Override
        public com.hjcenry.threadPool.order.OrderedThreadSession getAttach() {
